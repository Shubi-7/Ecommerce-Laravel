...
<body>
  ...
  @include('frontlayout.front_content')
    ...
    <script src="{{asset('frontend/js/bootstrap.min.js')}}" src="js/bootstrap.min.js"></script>
    <script src="{{asset('frontend/js/jquery.scrollUp.min.js')}}" src=""></script>
